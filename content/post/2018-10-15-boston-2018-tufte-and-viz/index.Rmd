...
- review
- R
description: "I recently attended Edward Tufte's course, 'Presenting Data and Information', in Boston."
---
...
```{r render, eval=FALSE, echo=FALSE, results=FALSE, warning=FALSE, message=FALSE}
...
![](index_files/figures-html/bostonsky.JPG#center){width='50%'}

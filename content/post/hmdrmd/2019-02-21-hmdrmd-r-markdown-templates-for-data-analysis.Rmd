...
subtitle: 'R Markdown templates for data analysis'
...
This framework is based on a now infamous diagram that describes the ["R for Data Science"](https://r4ds.had.co.nz/index.html){target="_blank"}<sup>[3](#myfootnote3)</sup> workflow (see *Figure 1*).
